...
<c:import url="http://localhost:8080/reservationpractice/products/${param.id }" var="detailData" scope="request"/>
<!DOCTYPE html>
<html>
	<head>
	    <meta charset="utf-8">
	...
	<body>
	    <div id="container">
	        <div class="header fade">
	            <header class="header_tit">
	                <h1 class="logo">
	                    <a href="../reservationpractice" class="lnk_logo" title="네이버"> <span class="spr_bi ico_n_logo">네이버</span> </a>
	                    <a href="../reservationpractice" class="lnk_logo" title="예약"> <span class="spr_bi ico_bk_logo">예약</span> </a>
	                </h1>
	                ...
	                <div class="section_visual">
	                    ...
	                    <div class="pagination">
	                        ...
	                        <div class="figure_pagination">
	                            <span class="num">1</span> <!--productImage -->
	                                ...
	                                <ul class="detail_info_group">
	                                    ...
	                                    <li class="detail_info_lst"> <strong class="in_tit">[공지사항]</strong>
	                                        <ul class="in_img_group">
	                                            <li class="in_img_lst"> <img alt="" class="img_thumb" src=""> </li>
	                                        </ul>
	                                    </li>
	                            ...
	                            <div class="store_info">
	                                ...
	                                <div class="lst_store_info_wrap">
	                                    <ul class="lst_store_info">
	                                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a href="tel:" class="store_tel"></a></span> </li>
	                                    </ul>
	                                </div>
	                            </div>
	    ...
	    <script type="rv-template" id="paginationItem">
        <li class="item" style="width: 414px; height: 414px;"> <img alt="{{productDescription}}" class="img_thumb" src="{{saveFileName}}"> <span class="img_bg"></span>
            <div class="visual_txt">
                <div class="visual_txt_inn">
    	...
    	<script type="myTemplate" id="commentImageTemplate">
        <li class="list_item">
            <div>
                <div class="review_area">
                    <div class="thumb_area">
                        <a href="#" class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="{{image}}" alt="리뷰이미지"> </a> <span class="img_count">{{imageCount}}</span>
                    </div>
                    <h4 class="resoc_name"></h4>
                    <p class="review">{{comment}}</p>
                </div>
                <div class="info_area">
                    <div class="review_info"> <span class="grade">{{score}}</span> <span class="name">{{email}}</span> <span class="date">{{reservationDate}} 방문</span> </div>
                </div>
            </div>
        </li>
		</script>	
    	...
    	<script type="myTemplate" id="detailInfoTemplate">
        <li class="detail_info_lst">
            <strong class="in_tit">[소개]</strong>
            <p class="in_dsc">{{productDescription}}
            </p>
        </li>
        <li class="detail_info_lst"> <strong class="in_tit">[공지사항]</strong>
            <ul class="in_img_group">
    	...
    	<script type="myTemplate" id="detailLocationTemplate">
        <div class="store_addr_wrap">
            <span class="fn fn-pin2"></span>
	    ...
	    <script type="text/javascript" src = "../reservationpractice/spec/detail.test.js"></script>
